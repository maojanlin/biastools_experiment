...
if __name__ == "__main__":
    ...
    if flag_real: # no simulation of mapping information provided
        ...
        balance_insert_assign,   balance_delete_assign   = calculate_gap_balance(list_bias_report[0][1], f_vcf, boundary, 5) # getting the simulated information
        sns.boxplot(balance_insert_assign[0])
        plt.show()
        sns.boxplot(balance_insert_assign[1])
        plt.show()
        sns.boxplot(balance_insert_assign[2])
        plt.show()
        sns.boxplot(balance_insert_assign[3])
        plt.show()
        sns.boxplot(balance_insert_assign[4])
        plt.show()
        print(sorted(balance_insert_assign[2]))
        print(balance_insert_assign[0].count(1.0)/len(balance_insert_assign[0]), np.nanmedian(balance_insert_assign[0]), np.nanmean(balance_insert_assign[0]))
        print(balance_insert_assign[1].count(1.0)/len(balance_insert_assign[1]), np.nanmedian(balance_insert_assign[1]), np.nanmean(balance_insert_assign[1]))
        print(balance_insert_assign[2].count(1.0)/len(balance_insert_assign[2]), np.nanmedian(balance_insert_assign[2]), np.nanmean(balance_insert_assign[2]))
        print(balance_insert_assign[3].count(1.0)/len(balance_insert_assign[3]), np.nanmedian(balance_insert_assign[3]), np.nanmean(balance_insert_assign[3]))
        print(balance_insert_assign[4].count(1.0)/len(balance_insert_assign[4]), np.nanmedian(balance_insert_assign[4]), np.nanmean(balance_insert_assign[4]))
        ...
        # fetch the gap balance information
        balance_insert_assign,   balance_delete_assign   = calculate_gap_balance(list_bias_report[0][1], f_vcf, boundary, 5) # getting the simulated information
        balance_insert_map,      balance_delete_map      = calculate_gap_balance(list_bias_report[0][1], f_vcf, boundary, 10) # getting the simulated information
        balance_insert_simulate, balance_delete_simulate = calculate_gap_balance(list_bias_report[0][1], f_vcf, boundary, 14) # getting the simulated information
        """
        plt.scatter(balance_insert_simulate[0], balance_insert_map[0])
        plt.show()
        plt.scatter(balance_delete_simulate[0], balance_delete_map[0])
        plt.show()
        plt.scatter(balance_insert_assign[0], balance_insert_map[0])
        plt.show()
        plt.scatter(balance_delete_assign[0], balance_delete_map[0])
        plt.show()
        plt.scatter(balance_insert_assign[0], balance_insert_simulate[0])
        plt.show()
        plt.scatter(balance_delete_assign[0], balance_delete_simulate[0])
        plt.show()
        sns.boxplot(balance_insert_map[0])
        plt.show()
        sns.boxplot(balance_insert_assign[0])
        plt.show()
        sns.boxplot(balance_delete_assign[0])
        plt.show()
        """
        list_diff = []
        for idx, ele in enumerate(balance_insert_map[2]):
            list_diff.append(ele - balance_insert_assign[2][idx])
        #sns.boxplot(list_diff)
        #plt.show()
        #plt.scatter(list_diff, balance_insert_map[0], alpha=0.3)
        #plt.show()
        sns.boxplot(balance_insert_assign[0])
        plt.show()
        sns.boxplot(balance_insert_assign[1])
        ...
        #print(sorted(balance_insert_assign[0]))
        #print(sorted(balance_delete_assign[0]))
        list_diff_2 = []
        for idx, ele in enumerate(balance_delete_map[0]):
            list_diff_2.append(ele - balance_delete_assign[0][idx])
        print(len(list_diff))
        print(count_negative_numbers(list_diff))
        print(len(list_diff_2))
        print(count_negative_numbers(list_diff_2))
        plt.hist(balance_insert_assign[2], bins=70)
        plt.show()
        plt.hist(balance_delete_assign[0], bins=70)
        plt.show()
        #sns.boxplot(list_diff_2)
        #plt.show()
        #plt.scatter(list_diff_2, balance_delete_map[0], alpha=0.3)
        #plt.show()
        """
